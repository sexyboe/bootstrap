...
<body>
  ...
  <div class="table_container">
    <div class="title1">
      ...
      <h3>Aprove List </h3> <span> Total Approved list : <strong>{{$count}}</strong></span>
    </div>
...
<tr>
  @forelse ($lists as $list)
    ...
    <td>
      ...
      <span class="approve"> <span class="ending"> <strong>
        Approved
      </strong> <i class="fa-regular fa-circle-check"></i> </span>
      @endif
...
<p class="message_pending"><strong>No Approved list </strong>   
</p>
